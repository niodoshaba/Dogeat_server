<?php
    ...
    class UserDatabase{
        ...
        function EachPageUserData($page,$data_count){
        ...
        function EachPageOrderData($page,$data_count){
            $page_count=($page-1)*$data_count;
            $pdo = new DbContext();
            $sql = "SELECT * 
                    FROM `order` 
                    LIMIT $page_count,$data_count";
            $order_Api = $pdo->query($sql);
            if( $order_Api->rowCount()==0)
            {
                return false;
        ...
        function SelectAllMemberMessage($page,$data_count){
            $page_count=($page-1)*$data_count;
            $pdo = new DbContext();
